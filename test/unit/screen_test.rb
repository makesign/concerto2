...
class ScreenTest < ActiveSupport::TestCase
  ...
  test 'find by mac' do
    assert_equal screens(:two), Screen.find_by(mac: 'a1:b2:c3')
    assert_equal screens(:two), Screen.find_by(mac: 'a1b2c3')
    assert_equal screens(:two), Screen.find_by(mac: '00:00:00:a1:b2:c3')
    assert_nil Screen.find_by(mac: '123')
  end
