...
class ConcertoDeviseRegistrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'registration processing disabled' do
    ConcertoConfig.set('allow_registration', 'false')
    post :create, params: { user: { first_name: 'Name', last_name: 'Last', email: 'a@a.com' } }
    assert_response :redirect
  end
  ...
  test 'user can change password' do
    sign_in users(:karen)
    put :update,
        params: { user: { current_password: 'password', password: 'pass1234', password_confirmation: 'pass1234' } }
  ...
  test 'new admin' do
    ...
    assert_difference('User.count', 1) do
      post :create,
           params: { user: { first_name: 'Name', last_name: 'Last', email: 'a@a.com', password: 'pass1234',
