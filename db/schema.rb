...
ActiveRecord::Schema[7.1].define(version: 20_240_622_122_959) do
  ...
  create_table 'media', force: :cascade do |t|
    ...
    t.string 'file_type'
    t.integer 'file_size'
    t.binary 'file_data', limit: 16_777_216
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[attachable_id attachable_type], name: 'index_media_on_attachable_id_and_attachable_type'
    t.index %w[attachable_type attachable_id], name: 'index_medias_on_attachable'
  end
  ...
  create_table 'screens', force: :cascade do |t|
    ...
    t.string 'time_zone'
    t.string 'locale'
    t.index %w[owner_type owner_id], name: 'index_screens_on_owner'
  ...
  create_table 'submissions', force: :cascade do |t|
    ...
    t.index %w[feed_id seq_no], name: 'index_submissions_on_feed_id_and_seq_no'
