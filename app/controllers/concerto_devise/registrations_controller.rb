  ...
  class RegistrationsController < Devise::RegistrationsController
    ...
    def create
      ...
      if resource.save
        ...
        ConcertoConfig.set('setup_complete', 'true') if ConcertoConfig[:setup_complete] == false
        ...
        if first_user_setup
          ...
          process_notification(membership, { user: resource, group:, adder: resource }, action: 'create',
                                                                                        owner: resource)
        end
